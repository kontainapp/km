...
Experimental:
```
 ../../../build/km/km --dynlinker=../../../build/runtime/libc.so --putenv="LD_LIBRARY_PATH=/opt/kontain/lib64:/lib64:./build/linux-x86_64-server-release/jdk.km/lib/" ./build/linux-x86_64-server-release/jdk/bin/java.kmd -Xmx512M -Xms512M -server -XX:+UseG1GC -XX:MaxGCPauseMillis=20 -XX:InitiatingHeapOccupancyPercent=35 -XX:+ExplicitGCInvokesConcurrent -Djava.awt.headless=true -Xlog:gc*:file=/home/muth/tmp/zookeeper-gc.log:time,tags:filecount=10,filesize=102400 -Dcom.sun.management.jmxremote=true -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dkafka.logs.dir=/home/muth/tmp/zookeeper.log -Dlog4j.configuration=file:/home/muth/tmp/kafka_log4j.properties -cp '/home/muth/tmp/kafka_jars/*' org.apache.zookeeper.server.quorum.QuorumPeerMain /home/muth/tmp/etc_kafka/zookeeper.properties
```
