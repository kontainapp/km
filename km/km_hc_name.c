...
// clang-format off
static const char* const hc_name[KM_MAX_HCALL] = {
   [0] = "read",
   [1] = "write",
   [2] = "open",
   [3] = "close",
   ...
   [HC_reserved1] = "reserved1",
   [HC_reserved2] = "reserved2",
   [HC_guest_interrupt] = "guest_interrupt",
   [HC_reserved3] = "reserved3",
   [HC_reserved4] = "reserved4",
...
{
   if (hc >= KM_MAX_HCALL || hc_name[hc] == 0) {
      return "n/a";
   }
   return hc_name[hc];
}
